...
public class NearbyFoodBean {
	...
	public NearbyFoodBean(double distance,String comment, String user_image, String food_name,
			int want_it_total, int pv_count, int comment_count,
			String user_name, String place_name, int nom_it_total,
			int tweet_id, int food_price, String picture_url) {
		super();
